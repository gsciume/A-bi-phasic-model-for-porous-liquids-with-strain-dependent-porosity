...
def Byrne_coefficients(equilibrium_fraction:dolfinx.default_scalar_type,interaction_fraction:dolfinx.default_scalar_type,decohesion_fraction:dolfinx.default_scalar_type,decohesion_pressure:dolfinx.default_scalar_type,**kwargs):
    ...
    **kwargs : dict, optional
    ...
    return alpha,beta  
# 
def Byrne_law(fraction_s:dolfinx.fem.Function,equilibrium_fraction:dolfinx.default_scalar_type,interaction_fraction:dolfinx.default_scalar_type,decohesion_fraction:dolfinx.default_scalar_type,decohesion_pressure:dolfinx.default_scalar_type,**kwargs):
    """ 
    ...
    **kwargs : dict, optional
    ...
    return ufl.conditional(ufl.lt(interaction_fraction, fraction_s), alpha * ((fraction_s - interaction_fraction)**2 * (fraction_s - equilibrium_fraction)) / (1 - fraction_s)**beta, 0)  
# 
def Linearized_Byrne(fraction_s:dolfinx.fem.Function,equilibrium_fraction:dolfinx.default_scalar_type,interaction_fraction:dolfinx.default_scalar_type,decohesion_fraction:dolfinx.default_scalar_type,decohesion_pressure:dolfinx.default_scalar_type,**kwargs):
    """ 
    ...
    **kwargs : dict, optional
    ...
    if log :
        ...
        alpha, beta = Byrne_coefficients(equilibrium_fraction,interaction_fraction,decohesion_fraction,decohesion_pressure)
    # erreur de signe
    # return - alpha * (equilibrium_fraction-interaction_fraction)**2/((1-equilibrium_fraction)**beta)*(fraction_s-equilibrium_fraction)
    B=alpha * (equilibrium_fraction-interaction_fraction)**2/((1-equilibrium_fraction)**beta)
    return B*(fraction_s-equilibrium_fraction)
# EoF